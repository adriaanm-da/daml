...
object Node {
  ...
  final case class NodeFetch(
    ...
    override def mapCid(f: ContractId => ContractId): NodeFetch =
  ...
  final case class NodeExercises[+Nid](
    ...
    override def mapCid(f: ContractId => ContractId): NodeExercises[Nid] = copy(
  ...
  final case class NodeLookupByKey(
    ...
    override def mapCid(f: ContractId => ContractId): NodeLookupByKey =
  ...
  object KeyWithMaintainers {
    implicit class CidContainerInstance[Val <: CidContainer[Val]](key: KeyWithMaintainers[Val])
      ...
      override def mapCid(f: ContractId => ContractId): KeyWithMaintainers[Val] =
  ...
  final case class NodeRollback[+Nid](
    ...
    override def mapCid(f: ContractId => ContractId): NodeRollback[Nid] = this
